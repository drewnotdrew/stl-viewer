...
//! [0]
void StlWidget::mousePressEvent(QMouseEvent *e) {
  // Save mouse press position
  mousePressPosition = QVector2D(e->position());
}

void StlWidget::mouseReleaseEvent(QMouseEvent *e) {
...
//! [1]
void StlWidget::timerEvent(QTimerEvent *) {
